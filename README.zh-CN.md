...
![Coding Agent Harness Dashboard 总览](docs-release/assets/dashboard-overview-zh.png)
...
![Coding Agent Harness Review 工作区](docs-release/assets/dashboard-review-zh.png)
