...
- 任务本地 `walkthrough.md` 记录任务是否完成收口；`governance/generated/Closeout-Index.md` 是生成索引。
...
| `closeoutStatus` | task-local `walkthrough.md` + generated Closeout Index | 区分收口缺失、待处理、已关闭。 |
