...
Usage:
  ...
  harness preset install <folder|zip|builtin-id> [--project] [--force] [--allow-scripts] [--json] [target]
  ...
  harness preset action <id> <action> --task <task-id> [--allow-scripts] [--json] [action flags...] [target]
...
} else if (["new-task", "task-phase", "task-start", "task-log", "task-block", "task-review", "task-complete", "lesson-promote", "lesson-sediment", "task-list", "task-index", "task-supersede", "task-delete", "task-archive", "task-reopen", "module-step"].includes(command)) {
