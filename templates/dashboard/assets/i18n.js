window.HarnessI18n = {
  "en": {
    ...
    "presetCatalogSubtitle": "Inspect project, user, and bundled task method packages without changing the filesystem.",
    ...
    "presetSeed": "Seed bundled presets",
    "presetUninstall": "Uninstall preset",
    "presetInstallSourcePlaceholder": "Local path or bundled preset id",
  ...
  "zh": {
    ...
    "presetCatalogSubtitle": "查看项目级、用户级和内置任务方法包，不改变文件系统。",
    ...
    "presetSeed": "种子安装内置 preset",
    "presetUninstall": "卸载 preset",
    "presetInstallSourcePlaceholder": "本机路径或内置 preset ID",
    "forceOverwrite": "强制覆盖",
