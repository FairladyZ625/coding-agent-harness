...
function moduleCard(module) {
  ...
  const brief = findDocument(`TARGET:coding-agent-harness/planning/modules/${moduleKey}/brief.md`) || findDocument(`TARGET:docs/09-PLANNING/MODULES/${moduleKey}/brief.md`);
